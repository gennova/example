<head>
  ...
  <title>Tendy Developer - IT Consultant & Software Developer</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Hot links</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="https://multisoftdeveloper.wordpress.com/">Personal Blog</a></li>
          ...
          <li><a href="{{ url('/porto') }}">Portfolio</a></li>
