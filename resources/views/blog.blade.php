          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="{{ url('/single') }}">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam quia</a>
              </h2>
              ...
              <div class="entry-meta">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{ url('/single') }}">12 Comments</a></li>
                </ul>
              </div>
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="{{ url('/single') }}">Nisi magni odit consequatur autem nulla dolorem</a>
              </h2>
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="{{ url('/single') }}">Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit sint.</a>
              </h2>
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="{{ url('/single') }}">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius exercitationem.</a>
              </h2>
